...
' Authorization
If res <> True Then
' Check parameters for saving H03 e-mails 
        if rSec <> "Notificacao" or rTipo <> "H03" Then
...
If Not oFile Is Nothing Then
	If oFile.Length > 0 Then
		...
		vbsSaveAs Request.ServerVariables("APPL_PHYSICAL_PATH") & "FDH\AvGeral\H03Mails" & "\" & FileName, FileContent
    End If
End If
