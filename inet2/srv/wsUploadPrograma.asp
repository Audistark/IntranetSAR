...
'------------------------------------------------------
'
'	Grava na Pasta FDH\Organizacao\Protudos
'
'	Usado pelo Excel pra upload de arquivos
'
'       Funcionalidade semelhante à de AvGeral
'      
...
' Initial implementation of Cadeia Produtiva 
        if rSec <> "Prod" or rTipo <> "CadeiaProdutiva" Then
...
If Not oFile Is Nothing Then
	If oFile.Length > 0 Then
		...
		vbsSaveAs Request.ServerVariables("APPL_PHYSICAL_PATH") & "FDH\Organizacao\Protudos" & "\" & FileName, FileContent
    End If
End If
