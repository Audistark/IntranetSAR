...
querySQL = "INSERT INTO ITTA (ITTA_REG, ITTA_SEQ, ITTA_REV, ITTA_GER, ITTA_TYPE, ITTA_TITLE, ITTA_DATE, ITTA_VALID) VALUES " & _
			"( 119, 7, '', 'GCVC', 'I', 'Período de vacância dos cargos de administração requeridos pelo RBAC 119', #09/23/2015#, 'Y')"
oDbFDH.Execute( querySQL )
...
querySQL = "INSERT INTO ITTA (ITTA_REG, ITTA_SEQ, ITTA_REV, ITTA_GER, ITTA_TYPE, ITTA_TITLE, ITTA_DATE, ITTA_VALID) VALUES " & _
			"( 119, 2, '', 'GCVC', 'B', 'Certificação dos operadores RBAC 121 e 135 para uso do Eletronic Flight Bag (EFB)', #07/24/2015#, 'Y')"
oDbFDH.Execute( querySQL )
...
querySQL = "INSERT INTO ITTA (ITTA_REG, ITTA_SEQ, ITTA_REV, ITTA_GER, ITTA_TYPE, ITTA_NUM, ITTA_TITLE, ITTA_DATE, ITTA_VALID) VALUES " & _
			"( 119, 5, '', 'GCVC', 'B', '119-005/GCVC', 'Aprovação de Lista de Equipamentos Mínimos (MEL) contendo menos itens que a Lista Mestra de Equipamentos Mínimos (MMEL)', #09/30/2015#, 'Y')"
oDbFDH.Execute( querySQL )
...
'querySQL = "INSERT INTO DTT (DTT_NUM, DTT_TYPE, DTT_TITLE, DTT_DATE, DTT_VALID) VALUES ( '91-001-15', 'B', 'Procedimento para quando identificadas inconsistências no Export C of A emitido pela FAA', '14/07/2015', 'Y')"
'oDbFDH.Execute( querySQL )

'querySQL = "Update DTT SET DTT_TITLE = 'Procedimento para quando identificadas inconsistências no Export C of A utilizado para nacionalização de aeronaves' WHERE DTT_NUM = '91-001-15'"
