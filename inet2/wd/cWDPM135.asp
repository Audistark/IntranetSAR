...
Class cWDPM135
	...
	'Declarations
	Private m_oAIRStats		' AIRStatistics
	...
	Public Default Function construct( gtar )
		...
		Set m_oAIRStats = (new cAIRStatistics)( Array("135", m_strGTAR, TSOL_TXCODI005) )	' Aprovação de PM
...
<%
		...
		m_oAIRStats.oData.Open()
		If m_oAIRStats.oData.FetchStart() > 0 Then
			Do
				m_nDate = m_oAIRStats.oData.dtDate
				If DateDiff("m", m_nDate, Date) < 6 And _
									   ...
									   m_oAIRData.ANAC30d & ", " & _
									    m_oAIRData.ClientDelay & ", " & _
									     m_oAIRData.Closed30d & ", " & _
										  m_oAIRData.Docs30d & "]")
				End If
			Loop While m_oAIRStats.oData.FetchNext() > 0
			m_oAIRStats.oData.Close()
		End If
		 %>
				]);
			var options = {
  ...
  <table border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td colspan=4 align="left"><a href="/AvGeral/CtrlProcMntRelatPendBySolic.asp?Solic=<%=TSOL_TXCODI005 %>&SDiv=<%=strGTAR %>&Sec=135"
		 style="text-decoration:none; color:Black;" target="_blank"><font
         size="5" face="Calibri"><strong>Programa de Manutenção de Táxi Aéreo - RBAC 135</strong></font></a></td>
	    <td width=26 height=30><img
  ...
  <table border="0" width="100%">
	...
	Private Sub GetValues()
		m_oAIRData.Import(m_oAIRStats.oData)
	End Sub
