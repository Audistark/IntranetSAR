...
Class cWDMEL135
	...
	Public Default Function construct( gtar )
		...
		Set m_oAIRStats = (new cAIRStatistics)( Array("135", m_strGTAR, TSOL_TXCODI004) )	' Aprovação de MEL
...
<%
  ...
  <table border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td colspan=4 align="left"><a href="/AvGeral/CtrlProcMntRelatPendBySolic.asp?Solic=<%=TSOL_TXCODI004 %>&SDiv=<%=strGTAR %>&Sec=135"
		 style="text-decoration:none; color:Black;" target="_blank"><font
         size="5" face="Calibri"><strong>MEL de Táxi Aéreo - RBAC 135</strong></font></a></td>
	    <td width=26 height=30><img
