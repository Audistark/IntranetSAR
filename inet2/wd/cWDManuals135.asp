...
Class cWDManuals135
	...
	'Declarations
	Private m_oAIRStats(2)		' AIRStatistics
	...
	Public Default Function construct( gtar )
		...
		Set m_oAIRStats(1) = (new cAIRStatistics)( Array("135", m_strGTAR, TSOL_TXCODI001) )	' Aceitação de MGM
		Set m_oAIRStats(2) = (new cAIRStatistics)( Array("135", m_strGTAR, TSOL_TXCODI002) )	' Aceitação/Aprov. de Outros Manuais
...
<%
		...
		If m_oAIRStats(1).oData.FetchStart() > 0 And m_oAIRStats(2).oData.FetchStart() > 0 Then
			Do
				...
				Do While m_nDate < m_oAIRStats(2).oData.dtDate
					...
					End If
				Loop
				If m_nDate = m_oAIRStats(2).oData.dtDate And _
									   ...
									   m_oAIRData.ANAC30d & ", " & _
									    m_oAIRData.ClientDelay & ", " & _
									     m_oAIRData.Closed30d & ", " & _
										  m_oAIRData.Docs30d & "]")
				End If
			Loop While m_oAIRStats(1).oData.FetchNext() > 0 And m_oAIRStats(2).oData.FetchNext() > 0
  ...
  <table border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td colspan=4 align="left"><a href="/AvGeral/CtrlProcMntRelatPendBySolic.asp?Solic=<%=TSOL_TXCODI001 %>&SDiv=<%=strGTAR %>&Sec=135"
		 style="text-decoration:none; color:Black;" target="_blank"><font
         size="5" face="Calibri"><strong>MGM e Outros Manuais de Táxi Aéreo - RBAC 135</strong></font></a></td>
	    <td width=26 height=30><img
