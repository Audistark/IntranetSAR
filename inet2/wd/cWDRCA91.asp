...
Class cWDRCA91
	...
	Public Default Function construct( gtar )
		...
		Set m_oAIRStats(1) = (new cAIRStatistics)( Array("145", m_strGTAR, TSOL_CODI018) )
		Set m_oAIRStats(2) = (new cAIRStatistics)( Array("135", m_strGTAR, TSOL_TXCODI024) )
...
<%
  ...
  <table border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td colspan=4 align="left"><a href="/AvGeral/CtrlProcMntRelatPendBySolic.asp?Solic=<%=TSOL_CODI018 %>&SDiv=<%=m_strGTAR %>&Sec=145"
		 style="text-decoration:none; color:Black;" target="_blank"><font
		 size="5" face="Calibri"><strong>RCA - RBAC 91</strong></font></a></td>
	    <td width=26 height=30><img
