...
Class cWDInclEO145
	...
	Public Default Function construct( gtar )
		...
		Set m_oAIRStats(1) = (new cAIRStatistics)( Array("145", m_strGTAR, TSOL_CODI001) )
		Set m_oAIRStats(2) = (new cAIRStatistics)( Array("145", m_strGTAR, TSOL_CODI015) )
...
<%
		...
		If m_oAIRStats(1).oData.FetchStart() > 0 And m_oAIRStats(2).oData.FetchStart() > 0 Then
			...
			Loop While m_oAIRStats(1).oData.FetchNext() > 0 And _
					   m_oAIRStats(2).oData.FetchNext() > 0
  ...
  <table border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td colspan=4 align="left"><a href="/AvGeral/CtrlProcMntRelatPendBySolic.asp?Solic=<%=TSOL_CODI001 %>&SDiv=<%=m_strGTAR %>&Sec=145"
		 style="text-decoration:none; color:Black;" target="_blank"><font
		 size="5" face="Calibri"><strong>Inclusão na EO de OM - RBAC 145</strong></font></a></td>
	    <td width=26 height=30><img
  ...
  <table border="0" width="100%" id="SplashChart<%=m_sTitle %>">
    <tr>
